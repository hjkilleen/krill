...
ep.est.sst <- data.frame(model = c("2013_F", "2013_M", "2015_F", "2015_M", "2017_F", "2017_M", "All"),
                     intercept = c(coef(summary(epm.13))[1,1]+ attr(ep$length, "scaled:center"), coef(summary(epm.13))[1,1]+ attr(ep$length, "scaled:center"), coef(summary(epm.15))[1,1]+ attr(ep$length, "scaled:center"), coef(summary(epm.15))[1,1]+ attr(ep$length, "scaled:center"), coef(summary(epm.17))[1,1]+ attr(ep$length, "scaled:center"), coef(summary(epm.17))[1,1]+ attr(ep$length, "scaled:center"), coef(summary(epm))[1,1]+ attr(ep$length, "scaled:center")),
                     ...
                     xmin = c(min(ep.dfs[[1]]$temp_2), min(ep.dfs[[1]]$temp_2), min(ep.dfs[[2]]$temp_2), min(ep.dfs[[2]]$temp_2), min(ep.dfs[[3]]$temp_2), min(ep.dfs[[3]]$temp_2), min(ep.dfs[[4]]$temp_2)),
                     xmax = c(max(ep.dfs[[1]]$temp_2), max(ep.dfs[[1]]$temp_2), max(ep.dfs[[2]]$temp_2), max(ep.dfs[[2]]$temp_2), max(ep.dfs[[3]]$temp_2), max(ep.dfs[[3]]$temp_2), max(ep.dfs[[4]]$temp_2)))
...
ep.est.cuti <- data.frame(model = c("2013_F", "2013_M", "2015_F", "2015_M", "2017_F", "2017_M", "All"),
                     ...
                     xmin = c(min(ep.dfs[[1]]$cuti), min(ep.dfs[[1]]$cuti), min(ep.dfs[[2]]$cuti), min(ep.dfs[[2]]$cuti), min(ep.dfs[[3]]$cuti), min(ep.dfs[[3]]$cuti), min(ep.dfs[[4]]$cuti)),
                     xmax = c(max(ep.dfs[[1]]$cuti), max(ep.dfs[[1]]$cuti), max(ep.dfs[[2]]$cuti), max(ep.dfs[[2]]$cuti), max(ep.dfs[[3]]$cuti), max(ep.dfs[[3]]$cuti), max(ep.dfs[[4]]$cuti)))
...
ep.est.chla <- data.frame(model = c("2013_F", "2013_M", "2015_F", "2015_M", "2017_F", "2017_M", "All"),
                     ...
                     xmin = c(min(ep.dfs[[1]]$chla), min(ep.dfs[[1]]$chla), min(ep.dfs[[2]]$chla), min(ep.dfs[[2]]$chla), min(ep.dfs[[3]]$chla), min(ep.dfs[[3]]$chla), min(ep.dfs[[4]]$chla)),
                     xmax = c(max(ep.dfs[[1]]$chla), max(ep.dfs[[1]]$chla), max(ep.dfs[[2]]$chla), max(ep.dfs[[2]]$chla), max(ep.dfs[[3]]$chla), max(ep.dfs[[3]]$chla), max(ep.dfs[[4]]$chla)))
...
ts.est.sst <- data.frame(model = c("2013_F", "2013_M", "2015_F", "2015_M", "2017_F", "2017_M", "All"),
                     intercept = c(coef(summary(tsm.13))[1,1]+ attr(ts$length, "scaled:center"), coef(summary(tsm.13))[1,1]+ attr(ts$length, "scaled:center"), coef(summary(tsm.15))[1,1]+ attr(ts$length, "scaled:center"), coef(summary(tsm.15))[1,1]+ attr(ts$length, "scaled:center"), coef(summary(tsm.17))[1,1]+ attr(ts$length, "scaled:center"), coef(summary(tsm.17))[1,1]+ attr(ts$length, "scaled:center"), coef(summary(tsm))[1,1]+ attr(ts$length, "scaled:center")),
                     ...
                     xmin = c(min(ts.dfs[[1]]$temp_2), min(ts.dfs[[1]]$temp_2), min(ts.dfs[[2]]$temp_2), min(ts.dfs[[2]]$temp_2), min(ts.dfs[[3]]$temp_2), min(ts.dfs[[3]]$temp_2), min(ts.dfs[[4]]$temp_2)),
                     xmax = c(max(ts.dfs[[1]]$temp_2), max(ts.dfs[[1]]$temp_2), max(ts.dfs[[2]]$temp_2), max(ts.dfs[[2]]$temp_2), max(ts.dfs[[3]]$temp_2), max(ts.dfs[[3]]$temp_2), max(ts.dfs[[4]]$temp_2)))
...
ts.est.cuti <- data.frame(model = c("2013_F", "2013_M", "2015_F", "2015_M", "2017_F", "2017_M", "All"),
                     ...
                     xmin = c(min(ts.dfs[[1]]$cuti), min(ts.dfs[[1]]$cuti), min(ts.dfs[[2]]$cuti), min(ts.dfs[[2]]$cuti), min(ts.dfs[[3]]$cuti), min(ts.dfs[[3]]$cuti), min(ts.dfs[[4]]$cuti)),
                     xmax = c(max(ts.dfs[[1]]$cuti), max(ts.dfs[[1]]$cuti), max(ts.dfs[[2]]$cuti), max(ts.dfs[[2]]$cuti), max(ts.dfs[[3]]$cuti), max(ts.dfs[[3]]$cuti), max(ts.dfs[[3]]$cuti)))
...
ts.est.chla <- data.frame(model = c("2013_F", "2013_M", "2015_F", "2015_M", "2017_F", "2017_M", "All"),
                     ...
                     xmin = c(min(ts.dfs[[1]]$chla), min(ts.dfs[[1]]$chla), min(ts.dfs[[2]]$chla), min(ts.dfs[[2]]$chla), min(ts.dfs[[3]]$chla), min(ts.dfs[[3]]$chla), min(ts.dfs[[4]]$chla, na.rm = TRUE)),
                     xmax = c(max(ts.dfs[[1]]$chla), max(ts.dfs[[1]]$chla), max(ts.dfs[[2]]$chla), max(ts.dfs[[2]]$chla), max(ts.dfs[[3]]$chla), max(ts.dfs[[3]]$chla), max(ts.dfs[[4]]$chla, na.rm = TRUE)))
...
nd.est.sst <- data.frame(model = c("2015_F", "2015_M", "2017_F", "2017_M", "All"),
                     intercept = c(coef(summary(ndm.15))[1,1] + attr(nd$length, "scaled:center"), coef(summary(ndm.15))[1,1] + attr(nd$length, "scaled:center"), coef(summary(ndm.17))[1,1] + attr(nd$length, "scaled:center"), coef(summary(ndm.17))[1,1] + attr(nd$length, "scaled:center"), coef(summary(ndm))[1,1] + attr(nd$length, "scaled:center")),
                     ...
                     xmin = c(min(nd.dfs[[1]]$temp_2), min(nd.dfs[[1]]$temp_2), min(nd.dfs[[2]]$temp_2), min(nd.dfs[[2]]$temp_2), min(nd.dfs[[3]]$temp_2)),
                     xmax = c(max(nd.dfs[[1]]$temp_2), max(nd.dfs[[1]]$temp_2), max(nd.dfs[[2]]$temp_2), max(nd.dfs[[2]]$temp_2), max(nd.dfs[[3]]$temp_2)))
...
nd.est.cuti <- data.frame(model = c("2015_F", "2015_M", "2017_F", "2017_M", "All"),
                     ...
                     xmin = c(min(nd.dfs[[1]]$cuti), min(nd.dfs[[1]]$cuti), min(nd.dfs[[2]]$cuti), min(nd.dfs[[2]]$cuti), min(nd.dfs[[3]]$cuti)),
                     xmax = c(max(nd.dfs[[1]]$cuti), max(nd.dfs[[1]]$cuti), max(nd.dfs[[2]]$cuti), max(nd.dfs[[2]]$cuti), max(nd.dfs[[3]]$cuti)))
...
nd.est.chla <- data.frame(model = c("2015_F", "2015_M", "2017_F", "2017_M", "All"),
                     ...
                     xmin = c(min(nd.dfs[[1]]$chla), min(nd.dfs[[1]]$chla), min(nd.dfs[[2]]$chla), min(nd.dfs[[2]]$chla), min(nd.dfs[[3]]$chla)),
                     xmax = c(max(nd.dfs[[1]]$chla), max(nd.dfs[[1]]$chla), max(nd.dfs[[2]]$chla), max(nd.dfs[[2]]$chla), max(nd.dfs[[2]]$chla)))
