#List of regions and corresponding stations
FortRoss <- c(452, 454)
...
#As a dataframe 
regions <- data.frame(
  region = c("FortRoss", "PointReyes", "GulfFarallons", "SanMateo", "Davenport", "MontereyBay", "PointSur", "PiedrasBlancas", "MorroBay", "PointConception", "SantaBarbara", "MidChannelIslands", "SouthernCA"),
