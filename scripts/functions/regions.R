...
regions <- data.frame(
  station = allSites,
  sites = c("FortRoss", "FortRoss", "FortRoss", "PointReyes", "PointReyes", "PointReyes", "PointReyes", "GulfFarallons", "GulfFarallons", "GulfFarallons", "GulfFarallons", "SanMateo", "SanMateo", "SanMateo", "Davenport", "Davenport", "MontereyBay", "MontereyBay", "MontereyBay", "MontereyBay", "PiedrasBlancas", "PiedrasBlancas", "MorroBay", "MorroBay", "SantaBarbara", "SantaBarbara", "MidChannelIslands", "MidChannelIslands", "MidChannelIslands", "MidChannelIslands", "SouthernCA", "SouthernCA", "SouthernCA"),
